...
(
    ...
    cover_url      varchar(128) DEFAULT 'https://youth6th-test.tos-cn-beijing.volces.com/video_covers%2Fdefault.png' COMMENT '视频封面地址',
...
(
    ...
    avatar           varchar(255) DEFAULT 'https://youth6th-test.tos-cn-beijing.volces.com/avatars%2Fdefault.png' COMMENT '用户头像',
    background_image varchar(255) DEFAULT 'https://youth6th-test.tos-cn-beijing.volces.com/backgrounds%2Fdefault.png' COMMENT '用户个人页顶部大图',
